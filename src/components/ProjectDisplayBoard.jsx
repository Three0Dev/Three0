...
import { Pagination, Typography, Toolbar, Box, AppBar, Card, CardContent, CardMedia} from '@mui/material'
        ...
        <>
            ...
            <Box sx={classes.container}>
                ...
                {projects.entries.map((project) => ( 
                        <Card key={project.contract_address} sx={{ display: 'flex', margin: "2% auto" }} onClick={() => navigate(`/app/${project.contract_address}/`)} >
                            <CardMedia
                                component="img"
                                sx={classes.logos}
                            ...
                            <Box sx={{ display: 'flex', flexDirection: 'column' }}>
                                ...
                                <Typography variant="subtitle1" color="text.secondary" component="div">
                                    {formatDistanceToNow(new Date(project.created_at/1000000))} ago
                                </Typography>
                                </CardContent>
                            </Box>
                    </Card>
                ...
                <Pagination sx={classes.root} defaultPage={1} count={Math.floor(projects.num/(limit_num))+1} boundaryCount={2} onChange={updatePage}> </Pagination>
