  ...
  return (
    ...
    >
      ...
      <DialogContent>
        ...
        <Select variant="outlined" fullWidth labelId="database-type" onChange={handleTypeChange} value={type}>
        ...
        <Select variant="outlined" fullWidth labelId="write-permissions" onChange={handlePermissionsChange} value={permissions}>
        ...
        <Select variant="outlined" fullWidth labelId="overwrite" onChange={handleOverwriteChange} value={overwrite}>
